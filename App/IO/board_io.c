...
#define INT_IO_DEBUG_LED2_PIN      GPIO_PIN_5
...
static struct_BoardIO_PinConfig stIO_PinConfig[]=
{
    ...
    { IO_INTERAL,   IO_EXPANDER_NONE, INT_IO_DEBUG_LED2_PORT,     INT_IO_VDD_TCXO_EXT_PIN,      GPIO_NOPULL,  IO_OUTPUT,  IO_HIGH_ACTIVE}, // INT_IO_DEBUG_LED2
